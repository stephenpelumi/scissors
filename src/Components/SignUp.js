...
var SignUp = function () {
    ...
    var _d = (0, react_1.useState)(""), retypePassword = _d[0], setRetypePassword = _d[1];
    ...
    var handleSignup = function (e) { return __awaiter(void 0, void 0, void 0, function () {
        var passwordPattern, userCredential, user, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error("Signup error:", error_1.message);
    ...
    return (react_1.default.createElement("div", null,
        react_1.default.createElement("main", { className: "main" },
            react_1.default.createElement("form", { onSubmit: handleSignup },
                react_1.default.createElement("p", { className: "SignUp_name" }, "Sign up with:"),
                react_1.default.createElement("div", { className: "google_and_apple" },
                    react_1.default.createElement("button", { className: "google" },
                        " ",
                    ...
                    react_1.default.createElement("button", { className: "Apple" },
                        " ",
                        react_1.default.createElement("img", { className: "Apple_img", alt: "", src: appleLogo_png_1.default }),
                        " ",
                ...
                react_1.default.createElement("div", { className: "the_actual_login" },
                    react_1.default.createElement("div", { className: "Inputs" },
                        ...
                        react_1.default.createElement("input", { className: "Username", type: "text", placeholder: "Username", value: username, onChange: function (e) { return setUsername(e.target.value); } })),
                    react_1.default.createElement("div", { className: "Inputs" },
                        react_1.default.createElement("input", { className: "Email", type: "Email", placeholder: "Email", value: email, onChange: function (e) { return setEmail(e.target.value); } })),
                    react_1.default.createElement("div", { className: "whole_password" },
                        react_1.default.createElement("input", { className: "Password", type: showPassword ? "text" : "password", placeholder: "Password", value: password, onChange: function (e) { return setPassword(e.target.value); } }),
                        react_1.default.createElement("img", { onClick: togglePasswordVisibility, className: "See_password", alt: "", src: Vector__1__png_1.default })),
                    react_1.default.createElement("div", { className: "whole_password" },
                        react_1.default.createElement("input", { className: "RetypePassword", type: ShowPassword ? "text" : "password", placeholder: "Retype Password", value: retypePassword, onChange: function (e) { return setRetypePassword(e.target.value); } }),
                        react_1.default.createElement("img", { onClick: togglePasswordvisibility, className: "See_password", alt: "", src: Vector__1__png_1.default })),
                    react_1.default.createElement("div", { className: "Discription" }, "6 or more characters, one number, one uppercase & one lower case.")),
                react_1.default.createElement("button", { type: "submit", className: "SignUp_Button" }, "Sign up with Email"),
                react_1.default.createElement("div", { className: "footer_question" },
                    "Already have an account?",
                    " ",
                    react_1.default.createElement(react_router_dom_1.Link, { to: "/login", className: "Log_In" }, "Log In")),
                react_1.default.createElement("div", { className: "footer_paragraph" },
                    " ",
                    react_1.default.createElement("p", { className: "text_effect" }, "By signing up, you agree to Sciccor's"),
                    " ",
